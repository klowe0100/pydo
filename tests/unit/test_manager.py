...
class OldTestDateManager:
    ...
    def test_convert_date_accepts_date_year_month_day(self):
        assert self.manager.convert("2019-05-05") == datetime.datetime.strptime(
            "2019-05-05", "%Y-%m-%d"
        )

    def test_convert_date_accepts_date_year_month_day_hour_min(self):
        assert self.manager.convert("2019-05-05T10:00") == datetime.datetime.strptime(
            "2019-05-05T10:00", "%Y-%m-%dT%H:%M"
        )

    def test_convert_date_accepts_monday(self):
        starting_date = datetime.date(2020, 1, 6)
        assert self.manager.convert("monday", starting_date) == datetime.date(
            2020, 1, 13
        )

    def test_convert_date_accepts_mon(self):
        starting_date = datetime.date(2020, 1, 6)
        assert self.manager.convert("mon", starting_date) == datetime.date(2020, 1, 13)

    def test_convert_date_accepts_tuesday(self):
        starting_date = datetime.date(2020, 1, 7)
        assert self.manager.convert("tuesday", starting_date) == datetime.date(
            2020, 1, 14
        )

    def test_convert_date_accepts_tue(self):
        starting_date = datetime.date(2020, 1, 7)
        assert self.manager.convert("tue", starting_date) == datetime.date(2020, 1, 14)

    def test_convert_date_accepts_wednesday(self):
        starting_date = datetime.date(2020, 1, 8)
        assert self.manager.convert("wednesday", starting_date) == datetime.date(
            2020, 1, 15
        )

    def test_convert_date_accepts_wed(self):
        starting_date = datetime.date(2020, 1, 8)
        assert self.manager.convert("wed", starting_date) == datetime.date(2020, 1, 15)

    def test_convert_date_accepts_thursdday(self):
        starting_date = datetime.date(2020, 1, 9)
        assert self.manager.convert("thursdday", starting_date) == datetime.date(
            2020, 1, 16
        )

    def test_convert_date_accepts_thu(self):
        starting_date = datetime.date(2020, 1, 9)
        assert self.manager.convert("thu", starting_date) == datetime.date(2020, 1, 16)

    def test_convert_date_accepts_friday(self):
        starting_date = datetime.date(2020, 1, 10)
        assert self.manager.convert("friday", starting_date) == datetime.date(
            2020, 1, 17
        )

    def test_convert_date_accepts_fri(self):
        starting_date = datetime.date(2020, 1, 10)
        assert self.manager.convert("fri", starting_date) == datetime.date(2020, 1, 17)

    def test_convert_date_accepts_saturday(self):
        starting_date = datetime.date(2020, 1, 11)
        assert self.manager.convert("saturday", starting_date) == datetime.date(
            2020, 1, 18
        )

    def test_convert_date_accepts_sat(self):
        starting_date = datetime.date(2020, 1, 11)
        assert self.manager.convert("sat", starting_date) == datetime.date(2020, 1, 18)

    def test_convert_date_accepts_sunday(self):
        starting_date = datetime.date(2020, 1, 12)
        assert self.manager.convert("sunday", starting_date) == datetime.date(
            2020, 1, 19
        )

    def test_convert_date_accepts_sun(self):
        starting_date = datetime.date(2020, 1, 12)
        assert self.manager.convert("sun", starting_date) == datetime.date(2020, 1, 19)

    def test_convert_date_accepts_1d(self):
        starting_date = datetime.date(2020, 1, 12)
        assert self.manager.convert("1d", starting_date) == datetime.date(2020, 1, 13)

    def test_convert_date_accepts_1mo(self):
        starting_date = datetime.date(2020, 1, 12)
        assert self.manager.convert("1mo", starting_date) == datetime.date(2020, 2, 12)

    def test_convert_date_accepts_1rmo(self):
        starting_date = datetime.date(2020, 1, 12)
        assert self.manager.convert("1rmo", starting_date) == datetime.date(2020, 2, 9)

    def test_convert_date_accepts_now(self):
        assert self.manager.convert("now").day == self.now.day

    def test_convert_date_accepts_today(self):
        assert self.manager.convert("today").day == self.now.day

    def test_convert_date_accepts_tomorrow(self):
        starting_date = datetime.date(2020, 1, 12)
        assert self.manager.convert("tomorrow", starting_date) == datetime.date(
            2020, 1, 13
        )
