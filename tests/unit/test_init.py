...
class TestMain:
    ...
    def setup(self, session):
        ...
        self.sessionmaker_patch = patch("pydo.sessionmaker", autospect=True)
    ...
    @pytest.mark.parametrize(
        "subcommand", ["add", "done", "del", "install", "open", None]
    )
    ...
    @pytest.mark.parametrize("subcommand", ["add", "done", "del"])
    def test_task_manager_is_initialized_when_needed(self, session, subcommand):
        self.parser_args.subcommand = subcommand
    ...
    def test_add_subcommand_creates_task(self):
        ...
        self.tm.return_value.add.assert_called_once_with(description=description,)
    ...
    def test_add_subcommand_creates_task_with_tags(self):
        ...
        self.tm.return_value.add.assert_called_once_with(
            description=description, tags=[tag],
        )
