...
class Testfulid:
    ...
    def test_representation(self):
        ...
        assert str(
            self.fulid.__repr__
        ) == "<bound method fulid.__repr__ of" + " <fulid('{}')>>".format(
            self.fulid.str
        )
    ...
    def test_fulid_from_str_generates_fulid(self):
        assert isinstance(self.fulid.from_str("01DW02J8WWJNB109DA0AAAAAAA"), fulid)
    ...
    def test_expand_sulid_returns_fulid_if_no_coincidence(self):
        ...
        assert self.fulid.sulid_to_fulid("a", fulids) == "01DWF3DM7EH40BTYB4SAAAAAAA"
