...
def _convert_weekday(
    human_date: str, starting_date: Optional[datetime] = None
) -> Optional[datetime]:
    """
...
def _str2date(modifier: str, starting_date: Optional[datetime] = None) -> datetime:
    """
    ...
    element_regexp = re.compile("[0-9]+[a-z]+")
...
def _next_weekday(
    weekday_number: int, starting_date: Optional[datetime] = None
) -> datetime:
    """
...
def _next_monthday(months: int, starting_date: Optional[datetime] = None):
    """
